...
export const editions: Edition[] = [
  {
    ...
    "tldr": [
      ...
      "**Cost per durable improvement has four levers, not one:** harness, model, tools and task. Most teams tune only the model.",
      "**Two production loops shipped in the last month show where the tax lands.** Neither they nor anyone else publishes the number that would settle it: the revert rate for agent-authored changes."
    ],
    "sections": [
      {
        "paras": [
          ...
          "A study published on 16 September puts a number on one part of that. **HarnessTax**, from UC Berkeley’s Sky Computing Lab with Arena’s Wei-Lin Chiang, holds the model constant and varies the harness — the scaffolding that decides what context an agent sees and what tools it can call. Five of the six authors are Berkeley: Melissa Z. Pan, Shuo Yang, Negar Arabzadeh, Ion Stoica and Matei Zaharia. Stoica and Zaharia are behind Spark, Ray and Databricks; Chiang co-created Chatbot Arena. **Arena sponsored the API access for the experiments**, which is worth stating plainly.",
          "The finding: on the same benchmark, with the same model, the scaffolding moves the bill far more than it moves the result."
        ],
        "sources": [
          {
            "label": "HarnessTax",
          ...
          {
            "label": "Arena mirror of the post",
            "url": "https://arena.ai/blog/coding-agents-harness-tax"
          }
        ]
      },
      {
        "heading": "1 — What the study measured",
        "paras": [
      ...
      {
        "heading": "3 — PostHog runs ninety scouts on itself",
        "paras": [
          "On 15 September, PostHog published an account of seven loops it runs on its own product. This is new material, distinct from the Replay Vision fix covered last edition.",
          "The architecture is a funnel. Scouts and signal sources emit signals; signals become reports; agents open pull requests for the actionable ones and ask for input on the rest. The docs state that **PostHog runs over 90 scouts on its own product**, and that after a merge, PostHog measures whether the change worked and feeds the result back.",
          ...
          "A 10 September changelog entry adds something more consequential than any single fix: **external MCP agents can now claim actionable reports from the inbox and attach implementation pull requests.** The signal layer is being opened to harnesses PostHog does not control — precisely the substitution HarnessTax says is worth several multiples.",
        ...
        "sources": [
          {
            "label": "PostHog, the loops we use every day",
            "url": "https://posthog.com/blog/self-driving-loops"
          },
          {
            "label": "PostHog self-driving docs",
            "url": "https://posthog.com/docs/self-driving"
          }
        ]
      },
      {
        "heading": "4 — Shopify’s River, and what a gate is worth",
        "paras": [
        ...
        "sources": [
          {
            "label": "Shopify Engineering, River",
            "url": "https://shopify.engineering/river-vulnerability-remediation"
          }
        ]
      },
      {
        "heading": "5 — The number nobody publishes",
        "paras": [
          "Across every account in this window, throughput and cost are disclosed. Figma reports a median cost of about $0.50 per agent PR review, with findings surfaced only once an agent holds 70% precision on a two-week lookback. Uber reports that more than 70% of pull requests are attributed to agents, with cost per thousand model requests down almost 34% and cost per session down 52% between February and August.",
        ...
        "sources": [
          {
            "label": "Figma, staying ahead of vulnerabilities with agents",
            "url": "https://www.figma.com/blog/how-figma-stays-ahead-of-vulnerabilities-with-agents/"
          },
          {
            "label": "Uber, running a software factory efficiently",
  ...
  {
    "slug": "09-self-improving-products-wave",
    "number": 9,
    "title": "The Self-Improving Products Wave",
    "date": "2026-09-14",
    "cover": "/pulse/09-cover.png",
    "linkedinUrl": "https://www.linkedin.com/pulse/autopilot-pulse-9-self-improving-products-wave-antonio-s--xw4we/",
    "tldr": [
    ...
    "sections": [
      ...
      {
        "heading": "1 — The companies to understand first",
        "paras": [
        ...
        "sources": [
          {
            ...
            "url": "https://posthog.com/self-driving"
          },
          {
            "label": "Amplitude Wave — closed beta",
            "url": "https://amplitude.com/wave"
          },
          {
            "label": "Datadog Bits Code — June announcement",
            "url": "https://www.datadoghq.com/blog/bits-code/"
          },
          {
            "label": "GitHub Agentic Workflows — June preview announcement",
          ...
          {
            "label": "Warp factory architecture",
            "url": "https://www.warp.dev/blog/agent-self-improving-software-factories"
          }
        ]
      },
      {
        "heading": "2 — Five categories, ten subcategories",
        "image": "/pulse/09-market-map.png",
        "imageAlt": "The Self-Improving Products Wave: five categories connect to ten subcategories and twenty representative companies. Lines indicate membership only, not market share.",
        "paras": [
        ...
        "sources": [
          ...
          {
            "label": "Webflow",
            "url": "https://webflow.com/feature/optimize"
          },
          {
            "label": "Coframe",
            "url": "https://www.coframe.com/"
          },
          {
            "label": "Sentry",
          ...
          {
            "label": "incident.io",
            "url": "https://incident.io/investigations"
          },
          {
            "label": "Resolve AI",
      ...
      {
        "heading": "PostHog: a confusing installation screen became a deployed fix",
        "paras": [
        ...
        "sources": [
          {
            "label": "PostHog’s account",
            "url": "https://posthog.com/blog/replay-vision"
          },
          {
            "label": "Public PR and deployment record",
            "url": "https://github.com/PostHog/posthog/pull/67643"
          }
        ]
      },
      {
        "heading": "HYBRD + Amplitude: production conversations exposed a prompt defect",
        "paras": [
        ...
        "sources": [
          {
            "label": "HYBRD’s account",
            "url": "https://amplitude.com/blog/hybrd-agent-evals-retention-signal"
          }
        ]
      },
      {
        "heading": "Sentry + Claude: expanding automation into the review workflow",
        "paras": [
        ...
        "sources": [
          {
            "label": "Sentry’s implementation report",
            "url": "https://blog.sentry.io/automated-debugging-workflow-sentry/"
          }
        ]
      },
      {
        "heading": "Sentry + Cursor: a customer moves from backlog to recurring fixes",
        "paras": [
        ...
        "sources": [
          {
            "label": "Customer account on Sentry’s blog",
            "url": "https://blog.sentry.io/57-bugs-to-1/"
          }
        ]
      },
      {
        "heading": "Warp + Claude: agents improve instructions for the next run",
        "paras": [
        ...
        "sources": [
          {
            "label": "Anthropic’s account of Warp’s implementation",
            "url": "https://claude.com/blog/how-warp-builds-self-improving-agents-on-claude"
          }
        ]
      },
      {
        "heading": "loveholidays + Codex: prototypes become live customer experiences",
        "paras": [
        ...
        "sources": [
          {
            "label": "OpenAI’s loveholidays case study",
            "url": "https://openai.com/index/loveholidays/"
          }
        ]
      },
      {
        "heading": "Cognition + OpenAI: a working verification example, with scale unquantified",
        "paras": [
        ...
        "sources": [
          {
            "label": "OpenAI’s Cognition case study",
            "url": "https://openai.com/index/cognition-devin-testing-with-astra/"
          }
        ]
      },
      {
        "heading": "3 — The path from pilot to scale",
        "paras": [
